...
/**
 * Static nav tree for Store & Inventory (titles + children only, no paths/icons).
 * Used as the single source of truth for module options in the Inventory Approval Matrix.
 * Update this when nav items are added or removed from the Store & Inventory section.
 */
export const storeInventoryNavTree = [
  ...
  },
  {
    ...
    children: [
      { title: 'GRN' },
      {
        ...
        children: [{ title: 'GIN List' }, { title: 'Create GIN' }],
      },
      { title: 'Transfers' },
      {
      ...
      },
      {
        ...
        children: [{ title: 'Scrap List' }, { title: 'Create Scrap' }],
      },
      {
  ...
  },
  {
    ...
    children: [{ title: 'Barcode Scanning' }],
  },
];
...
export function useNavData() {
  ...
  // Fetch employee details if user is Employee
  ...
  const hasPermission = useCallback(
    (codename) => {
      // Grant all permissions if the user is a superuser or admin
    ...
    [user?.user_permissions_list, user?.is_superuser, user?.role]
  );
  ...
  const navData = useMemo(() => {
    const employeeChildren = [
      ...(hasPermission('view_employee')
        ...
        : []),
      // If user has employee permission, show Account Information inside Employee Management
      ...(hasPermission('view_employee')
        ? [
            {
    ...
    const holidayChildren = [
      ...(hasPermission('view_holiday')
        ? [
            ...
            // Show Holiday Calendar inside Holiday Management if permission exists
            {
        ...
        : []),
      // If user does NOT have holiday permission, but is not Employee/Supervisor, show Calendar
    ...
    return decorateNavItems([
      ...
      {
        subheader: 'Todo Management',
        items: [
          {
            title: 'Todo List',
            path: paths.dashboard.todo.list,
            icon: ICONS.todo,
          },
          {
            title: 'Create Todo',
            path: paths.dashboard.todo.create,
            icon: ICONS.formAutomation,
          },
        ],
      },
      {
        subheader: 'Procurement Management',
        items: [
          {
            title: 'Dashboard',
          ...
          },
          {
            ...
            children: [
              ...
              //   path: paths.dashboard.procurement.inventory.movement,
              //   icon: ICONS.inventory,
              // },
              // {
              //   title: 'Issue/Transfer',
              //   path: paths.dashboard.procurement.inventory.issue,
              //   icon: ICONS.delivery,
              // },
              // {
              //   title: 'Warehouses',
              //   path: paths.dashboard.procurement.inventory.warehouses,
              //   icon: ICONS.inventory,
              // },
              // {
              //   title: 'Inter-Warehouse Transfer',
              //   path: paths.dashboard.procurement.inventory.interWarehouseTransfer,
              //   icon: ICONS.inventory,
              // },
              // {
              //   title: 'Material Requisition',
              //   path: paths.dashboard.procurement.inventory.materialRequisition,
              //   icon: ICONS.requisition,
              // },
              // {
              //   title: 'Material Release',
              //   path: paths.dashboard.procurement.inventory.materialRelease,
              //   icon: ICONS.delivery,
              // },
              // {
              //   title: 'Inventory Reports',
              //   path: paths.dashboard.procurement.inventory.reports,
              //   icon: ICONS.reports,
              // },
            ],
          },
          ...
          },
          {
            ...
            children: [
              ...
              //   path: paths.dashboard.procurement.treasury.analytics,
              //   icon: ICONS.analytics,
              // },
              // {
              //   title: 'Bank Reconciliation',
              //   path: paths.dashboard.procurement.treasury.bankReconciliation,
              //   icon: ICONS.approval,
              // },
            ],
          },
          {
            ...
            children: [
              ...
              //   path: paths.dashboard.procurement.vendors.onboarding,
              //   icon: ICONS.formAutomation,
              // },
              {
              ...
              //   path: paths.dashboard.procurement.vendors.performance,
              //   icon: ICONS.analytics,
              // },
              {
          ...
          //   path: paths.dashboard.procurement.contracts.root,
          //   icon: ICONS.documents,
          //   children: [
          //     {
          //       title: 'Contract List',
          //       path: paths.dashboard.procurement.contracts.list,
          //       icon: ICONS.documents,
          //     },
          //     {
          //       title: 'Create Contract',
          //       path: paths.dashboard.procurement.contracts.create,
          //       icon: ICONS.formAutomation,
          //     },
          //   ],
          // },
          ...
          //   path: paths.dashboard.procurement.documents.root,
          //   icon: ICONS.documents,
          //   children: [
          //     {
          //       title: 'All Documents',
          //       path: paths.dashboard.procurement.documents.repository,
          //       icon: ICONS.documents,
          //     },
          //     {
          //       title: 'Categories',
          //       path: paths.dashboard.procurement.documents.categories,
          //       icon: ICONS.categories,
          //     },
          //     {
          //       title: 'Access Control',
          //       path: paths.dashboard.procurement.documents.accessControl,
          //       icon: ICONS.lock,
          //     },
          //   ],
          // },
          ...
          //   path: paths.dashboard.procurement.audit.root,
          //   icon: ICONS.approval,
          //   children: [
          //     {
          //       title: 'Audit Trail',
          //       path: paths.dashboard.procurement.audit.log,
          //       icon: ICONS.reports,
          //     },
          //     {
          //       title: 'Compliance Dashboard',
          //       path: paths.dashboard.procurement.audit.compliance,
          //       icon: ICONS.approval,
          //     },
          //     {
          //       title: 'Export & Reports',
          //       path: paths.dashboard.procurement.audit.export,
          //       icon: ICONS.external,
          //     },
          //   ],
          // },
          ...
          //   path: paths.dashboard.procurement.budget.root,
          //   icon: ICONS.accounting,
          //   children: [
          //     {
          //       title: 'Budget Planning',
          //       path: paths.dashboard.procurement.budget.planning,
          //       icon: ICONS.accounting,
          //     },
          //     {
          //       title: 'Utilization Report',
          //       path: paths.dashboard.procurement.budget.utilization,
          //       icon: ICONS.analytics,
          //     },
          //     {
          //       title: 'Budget Transfer',
          //       path: paths.dashboard.procurement.budget.transfer,
          //       icon: ICONS.external,
          //     },
          //   ],
          // },
      ...
      //     {
      //       title: 'Dashboard',
      //       path: paths.dashboard.projectManagement.dashboard,
      //       icon: ICONS.dashboard,
      //     },
      //     {
      //       title: 'Workspaces',
      //       path: paths.dashboard.projectManagement.workspaces.root,
      //       icon: ICONS.projects,
      //     },
      //     {
      //       title: 'Spaces',
      //       path: paths.dashboard.projectManagement.spaces.root,
      ...
      //         {
      //           title: 'Create Space',
      //           path: paths.dashboard.projectManagement.spaces.create,
      //           icon: ICONS.formAutomation,
      //         },
      //       ],
      //     },
      //     {
      //       title: 'Tasks',
      //       path: paths.dashboard.projectManagement.tasks.root,
      //       icon: ICONS.requisition,
      //       children: [
      //         {
      //           title: 'List View',
      //           path: paths.dashboard.projectManagement.tasks.list,
      //           icon: ICONS.menuItem,
      //         },
      //         {
      //           title: 'Board View',
      //           path: paths.dashboard.projectManagement.tasks.board,
      //           icon: ICONS.dashboard,
      //         },
      //         {
      //           title: 'Calendar View',
      //           path: paths.dashboard.projectManagement.tasks.calendar,
      //           icon: ICONS.calendar,
      //         },
      //         {
      //           title: 'Gantt Chart',
      //           path: paths.dashboard.projectManagement.tasks.gantt,
      //           icon: ICONS.shift,
      //         },
      //         {
      //           title: 'Timeline View',
      //           path: paths.dashboard.projectManagement.tasks.timeline,
      //           icon: ICONS.shift,
      //         },
      //         {
      //           title: 'Table View',
      //           path: paths.dashboard.projectManagement.tasks.table,
      //           icon: ICONS.menuItem,
      //         },
      //         {
      //           title: 'Create Task',
      //           path: paths.dashboard.projectManagement.tasks.create,
      //           icon: ICONS.formAutomation,
      //         },
      //       ],
      //     },
      //     {
      //       title: 'Sprints',
      //       path: paths.dashboard.projectManagement.sprints.root,
      //       icon: ICONS.shift,
      //       children: [
      //         {
      //           title: 'Sprint Board',
      //           path: paths.dashboard.projectManagement.sprints.board,
      //           icon: ICONS.dashboard,
      //         },
      //         {
      //           title: 'Backlog',
      //           path: paths.dashboard.projectManagement.sprints.backlog,
      //           icon: ICONS.menuItem,
      //         },
      //         {
      //           title: 'Retrospective',
      //           path: paths.dashboard.projectManagement.sprints.retrospective,
      //           icon: ICONS.reports,
      //         },
      //       ],
      //     },
      //     {
      //       title: 'Time Tracking',
      //       path: paths.dashboard.projectManagement.timeTracking.root,
      //       icon: ICONS.shift,
      //       children: [
      //         {
      //           title: 'My Time',
      ...
      //         {
      //           title: 'Timesheets',
      //           path: paths.dashboard.projectManagement.timeTracking.timesheets,
      //           icon: ICONS.calendar,
      //         },
      //         {
      //           title: 'Time Reports',
      //           path: paths.dashboard.projectManagement.timeTracking.reports,
      //           icon: ICONS.reports,
      //         },
      //         {
      //           title: 'Workload',
      //           path: paths.dashboard.projectManagement.timeTracking.workload,
      //           icon: ICONS.analytics,
      //         },
      //       ],
      //     },
      //     {
      //       title: 'Goals & OKRs',
      //       path: paths.dashboard.projectManagement.goals.root,
      //       icon: ICONS.analytics,
      //       children: [
      //         {
      //           title: 'All Goals',
      ...
      //         {
      //           title: 'Create Goal',
      //           path: paths.dashboard.projectManagement.goals.create,
      //           icon: ICONS.formAutomation,
      //         },
      //       ],
      //     },
      //     {
      //       title: 'Docs & Wiki',
      //       path: paths.dashboard.projectManagement.docs.root,
      //       icon: ICONS.documents,
      //       children: [
      //         {
      //           title: 'All Docs',
      ...
      //         {
      //           title: 'Create Doc',
      //           path: paths.dashboard.projectManagement.docs.create,
      //           icon: ICONS.formAutomation,
      //         },
      //       ],
      //     },
      //     {
      //       title: 'Automations',
      //       path: paths.dashboard.projectManagement.automations.root,
      //       icon: ICONS.settings,
      //     },
      //     {
      //       title: 'Dashboards & Reports',
      //       path: paths.dashboard.projectManagement.reports.root,
      //       icon: ICONS.reports,
      //     },
      //     {
      //       title: 'Team & Members',
      //       path: paths.dashboard.projectManagement.team.root,
      //       icon: ICONS.beneficiaries,
      //       children: [
      //         {
      //           title: 'Members',
      //           path: paths.dashboard.projectManagement.team.members,
      //           icon: ICONS.user,
      //         },
      //         {
      //           title: 'Roles & Permissions',
      //           path: paths.dashboard.projectManagement.team.roles,
      //           icon: ICONS.lock,
      //         },
      //       ],
      //     },
      //     {
      //       title: 'Whiteboards',
      //       path: paths.dashboard.projectManagement.whiteboards.root,
      //       icon: ICONS.dashboard,
      //     },
      //     {
      //       title: 'Forms',
      //       path: paths.dashboard.projectManagement.forms.root,
      //       icon: ICONS.formAutomation,
      //     },
      //     {
      //       title: 'Milestones',
      //       path: paths.dashboard.projectManagement.milestones.root,
      //       icon: ICONS.analytics,
      //     },
      //     {
      //       title: 'Saved Views',
      //       path: paths.dashboard.projectManagement.views.root,
      //       icon: ICONS.menuItem,
      //     },
      //     {
      //       title: 'Activity Log',
      //       path: paths.dashboard.projectManagement.activity,
      //       icon: ICONS.shift,
      //     },
      //     {
      //       title: 'Favorites',
      //       path: paths.dashboard.projectManagement.favorites,
      //       icon: ICONS.categories,
      //     },
      //     {
      //       title: 'Inbox',
      //       path: paths.dashboard.projectManagement.inbox,
      //       icon: ICONS.notifications,
      //     },
      //     {
      //       title: 'Templates',
      //       path: paths.dashboard.projectManagement.templates.root,
      //       icon: ICONS.documents,
      //     },
      //     {
      //       title: 'Notifications',
      //       path: paths.dashboard.projectManagement.notifications,
      //       icon: ICONS.notifications,
      //     },
      //     {
      //       title: 'Import / Export',
      //       path: paths.dashboard.projectManagement.importExport,
      //       icon: ICONS.external,
      //     },
      //     {
      //       title: 'Settings',
      //       path: paths.dashboard.projectManagement.settings.root,
      //       icon: ICONS.settings,
      //       children: [
      //         {
      //           title: 'General',
      //           path: paths.dashboard.projectManagement.settings.general,
      //           icon: ICONS.settings,
      //         },
      //         {
      //           title: 'Statuses',
      //           path: paths.dashboard.projectManagement.settings.statuses,
      //           icon: ICONS.approval,
      //         },
      //         {
      //           title: 'Custom Fields',
      //           path: paths.dashboard.projectManagement.settings.customFields,
      //           icon: ICONS.categories,
      //         },
      //         {
      //           title: 'Integrations',
      //           path: paths.dashboard.projectManagement.settings.integrations,
      //           icon: ICONS.external,
      //         },
      //       ],
      //     },
      ...
      },
      {
        ...
        items: [
          // Show Account directly for Employee/Supervisor role only if no employee permission
          ...
          //       path: paths.dashboard.projects.dashboard,
          //       icon: ICONS.dashboard,
          //     },
          //     {
          //       title: 'Planning',
          //       path: paths.dashboard.projects.planning,
          //       icon: ICONS.menuItem,
          //     },
          //     {
          //       title: 'Budget & Finance',
          //       path: paths.dashboard.projects.budget_finance,
          //       icon: ICONS.accounting,
          //     },
          //     {
          //       title: 'M&E System',
          //       path: paths.dashboard.projects.me_system,
          //       icon: ICONS.analytics,
          //     },
          //     {
          //       title: 'Risk Management',
          //       path: paths.dashboard.projects.risk_management,
          //       icon: ICONS.approval,
          //     },
          //     {
          //       title: 'Resource Allocation',
          //       path: paths.dashboard.projects.resource_allocation,
          //       icon: ICONS.projects,
          //     },
          //     {
          //       title: 'Donor Reporting',
          //       path: paths.dashboard.projects.donor_reporting,
          //       icon: ICONS.reports,
          //     },
          //     {
          //       title: 'Stakeholder Management',
          //       path: paths.dashboard.projects.stakeholder_management,
          //       icon: ICONS.user,
          //     },
          //     {
          //       title: 'Document Repository',
          //       path: paths.dashboard.projects.document_repository,
          //       icon: ICONS.documents,
          //     },
          //     {
          //       title: 'Project Analytics',
          //       path: paths.dashboard.projects.project_analytics,
          //       icon: ICONS.analytics,
          //     },
          //   ],
          // },
          ...
          // {
          //   title: 'Procurement',
          //   path: paths.dashboard.procurement_before.root,
          //   icon: ICONS.procurement,
          //   children: [
          //     {
          //       title: 'Purchase Requisitions',
          //       path: paths.dashboard.procurement_before.purchase_requisitions,
          //       icon: ICONS.requisition,
          //       children: [
          //         {
          //           title: 'All P.R',
          ...
          //         {
          //           title: 'Add P.R',
          //           path: paths.dashboard.procurement_before.add_purchase_requisition,
          //           icon: ICONS.formAutomation,
          //         },
          //       ],
          //     },
          //     {
          //       title: 'Approvals',
          //       path: paths.dashboard.procurement_before.approvals,
          //       icon: ICONS.approval,
          //     },
          //     {
          //       title: 'Supplier Management',
          //       path: paths.dashboard.procurement_before.supplier_management,
          //       icon: ICONS.vendors,
          //       children: [
          //         {
          //           title: 'All Suppliers',
          ...
          //         {
          //           title: 'Add Supplier',
          //           path: paths.dashboard.procurement_before.add_supplier,
          //           icon: ICONS.formAutomation,
          //         },
          //       ],
          //     },
          ...
          //       path: paths.dashboard.procurement_before.request_for_quotation,
          //       icon: ICONS.rfq,
          //       children: [
          //         {
          //           title: 'All R.F.Q',
          ...
          //         {
          //           title: 'Add R.F.Q',
          //           path: paths.dashboard.procurement_before.add_request_for_quotation,
          //           icon: ICONS.formAutomation,
          //         },
          //       ],
          //     },
          ...
          //       path: paths.dashboard.procurement_before.purchase_orders,
          //       icon: ICONS.workOrder,
          //       children: [
          //         {
          //           title: 'All P.O',
          ...
          //         {
          //           title: 'Add P.O',
          //           path: paths.dashboard.procurement_before.add_purchase_order,
          //           icon: ICONS.formAutomation,
          //         },
          //       ],
          //     },
          ...
          //       path: paths.dashboard.procurement_before.comparative_statement,
          //       icon: ICONS.comparison,
          //     },
          //     {
          //       title: 'Procurement Analytics',
          //       path: paths.dashboard.procurement_before.procurement_analytics,
          //       icon: ICONS.analytics,
          //     },
          //   ],
          // },
          ...
          //   path: paths.dashboard.formAutomation.root,
          //   icon: ICONS.formAutomation,
          //   children: [
          //     {
          //       title: 'Form Builder',
          //       path: paths.dashboard.formAutomation.form_builder,
          //       icon: ICONS.formAutomation,
          //     },
          //     {
          //       title: 'Form Submissions',
          //       path: paths.dashboard.formAutomation.form_submissions,
          //       icon: ICONS.documents,
          //     },
          //     {
          //       title: 'Approval Workflow',
          //       path: paths.dashboard.formAutomation.approval_workflow,
          //       icon: ICONS.approval,
          //     },
          //     {
          //       title: 'Form Analytics',
          //       path: paths.dashboard.formAutomation.form_analytics,
          //       icon: ICONS.analytics,
          //     },
          //   ],
          // },
...

      {
        ...
        items: [
          ...
          ...(employeeChildren.length > 0
            ...
            : []),
          // Settings menu: only if user has at least one settings permission
            ...
            : []),
          {
            ...
            children: [
              ...(hasPermission('view_attendance')
                ? [{ title: 'List', path: paths.dashboard.attendance.list, icon: ICONS.menuItem }]
                : []),
              // Only show Web Login if allowed
          ...
          // Remove Holiday Calendar from outside Holiday Management if user has permission
          ...((user?.role === 'Employee' || user?.role === 'Supervisor') &&
          !hasPermission('view_holiday')
            ? [
                {
        ...
        items: [
          ...
          },
          {
            ...
            children: [
              ...
              //   path: paths.dashboard.beneficiaries.bulk_registration,
              //   icon: ICONS.documents,
              // },
              // {
              //   title: 'Duplicate Management',
              //   path: paths.dashboard.beneficiaries.duplicate_management,
              //   icon: ICONS.approval,
              // },
              {
          ...
          //   path: paths.dashboard.beneficiaries.service_delivery,
          //   icon: ICONS.delivery,
          //   children: [
          //     {
          ...
          //       path: paths.dashboard.beneficiaries.service_categories,
          //       icon: ICONS.categories,
          //     },
          //     {
          //       title: 'Service Calendar',
          //       path: paths.dashboard.beneficiaries.service_calendar,
          //       icon: ICONS.calendar,
          //     },
          //     {
          //       title: 'Distribution Plan',
          //       path: paths.dashboard.beneficiaries.distribution_plan,
          //       icon: ICONS.requisition,
          //     },
          //   ],
          // },
          ...
          //   path: paths.dashboard.beneficiaries.case_management,
          //   icon: ICONS.menuItem,
          //   children: [
          //     {
          //       title: 'All Cases',
          ...
          //     },
          //     {
          //       title: 'Case Worker Assignment',
          //       path: paths.dashboard.beneficiaries.case_worker_assignment,
          //       icon: ICONS.user,
          //     },
          //     {
          //       title: 'Follow-Up Schedule',
          //       path: paths.dashboard.beneficiaries.follow_up_schedule,
          //       icon: ICONS.calendar,
          //     },
          //   ],
          // },
          ...
          //   path: paths.dashboard.beneficiaries.impact_measurement,
          //   icon: ICONS.analytics,
          //   children: [
          //     {
          ...
          //       path: paths.dashboard.beneficiaries.outcome_indicators,
          //       icon: ICONS.reports,
          //     },
          //     {
          //       title: 'Progress Tracking',
          //       path: paths.dashboard.beneficiaries.progress_tracking,
          //       icon: ICONS.shift,
          //     },
          //   ],
          // },
          // {
          //   title: 'Referral & Linkages',
          //   path: paths.dashboard.beneficiaries.referral_management,
          //   icon: ICONS.external,
          //   children: [
          //     {
          ...
          //       path: paths.dashboard.beneficiaries.referral_network,
          //       icon: ICONS.projects,
          //     },
          //   ],
          // },
          ...
          // {
          //   title: 'Exit & Graduation',
          //   path: paths.dashboard.beneficiaries.exit_graduation,
          //   icon: ICONS.approval,
          //   children: [
          //     {
          //       title: 'Exit / Graduation',
          ...
          //       path: paths.dashboard.beneficiaries.graduation_criteria,
          //       icon: ICONS.settings,
          //     },
          //     {
          //       title: 'Alumni Tracking',
          //       path: paths.dashboard.beneficiaries.alumni_tracking,
          //       icon: ICONS.user,
          //     },
          //   ],
          // },
          ...
          //   path: paths.dashboard.beneficiaries.protection_cases,
          //   icon: ICONS.lock,
          //   children: [
          //     {
          ...
          //       path: paths.dashboard.beneficiaries.consent_management,
          //       icon: ICONS.documents,
          //     },
          //     {
          //       title: 'Safeguarding Incidents',
          //       path: paths.dashboard.beneficiaries.safeguarding_incidents,
          //       icon: ICONS.notifications,
          //     },
          //   ],
          // },
        ...
        items: [
          ...
          },
          {
            ...
            children: [
              ...
              //   path: paths.dashboard.storeInventory.productVariants,
              //   icon: ICONS.categories,
              // },
              {
              ...
              //   path: paths.dashboard.storeInventory.packagingTypes,
              //   icon: ICONS.delivery,
              // },
              // {
              //   title: 'Product Templates',
              //   path: paths.dashboard.storeInventory.productTemplates,
              //   icon: ICONS.documents,
              // },
              // {
              //   title: 'Kitting / BOM',
              //   path: paths.dashboard.storeInventory.kittingBom,
              //   icon: ICONS.requisition,
              // },
              // {
              //   title: 'Reorder Rules',
              //   path: paths.dashboard.storeInventory.reorderRules,
              //   icon: ICONS.settings,
              // },
            ],
          },
          {
            ...
            children: [
              ...
              // {
              //   title: 'Location Stock Ledger',
              //   path: paths.dashboard.storeInventory.location_stocks,
              //   icon: ICONS.inventory,
              // },
              // {
              //   title: 'Cycle Counting',
              //   path: paths.dashboard.storeInventory.cycleCounting,
              //   icon: ICONS.analytics,
              // },
              // {
              //   title: 'Returns',
              //   path: paths.dashboard.storeInventory.returns,
              //   icon: ICONS.menuItem,
              // },
              // {
              //   title: 'Batch Transfers',
              //   path: paths.dashboard.storeInventory.batchTransfers,
              //   icon: ICONS.requisition,
              // },
              {
                title: 'Scrap Management',
              ...
              // {
              //   title: 'Backorders',
              //   path: paths.dashboard.storeInventory.backorders,
              //   icon: ICONS.documents,
              // },
              // {
              //   title: 'Replenishment',
              //   path: paths.dashboard.storeInventory.replenishment,
              //   icon: ICONS.formAutomation,
              // },
              // {
              //   title: 'Dropshipping',
              //   path: paths.dashboard.storeInventory.dropshipping,
              //   icon: ICONS.delivery,
              // },
              // {
              //   title: 'Cross-Docking',
              //   path: paths.dashboard.storeInventory.crossDocking,
              //   icon: ICONS.delivery,
              // },
              // {
              //   title: 'Inventory Log',
              //   path: paths.dashboard.storeInventory.operationInventoryLog,
              //   icon: ICONS.inventory,
              //   children: [
              //     {
              //       title: 'History',
              //       path: paths.dashboard.storeInventory.operationInventoryLogHistory,
              //       icon: ICONS.shift,
              //     },
              //   ],
              // },
          ...
          },
          {
            ...
            children: [
              ...
              //   path: paths.dashboard.storeInventory.storageLocations,
              //   icon: ICONS.branch,
              // },
              // {
              //   title: 'Putaway Rules',
              //   path: paths.dashboard.storeInventory.putawayRules,
              //   icon: ICONS.settings,
              // },
              // {
              //   title: 'Removal Strategies',
              //   path: paths.dashboard.storeInventory.removalStrategies,
              //   icon: ICONS.menuItem,
              // },
              // {
              //   title: 'Routes & Rules',
              //   path: paths.dashboard.storeInventory.routesAndRules,
              //   icon: ICONS.requisition,
              // },
              // {
              //   title: 'Operation Types',
              //   path: paths.dashboard.storeInventory.operationTypes,
              //   icon: ICONS.categories,
              // },
            ],
          },
          ...
          //   path: paths.dashboard.storeInventory.lotSerialNumbers,
          //   icon: ICONS.documents,
          //   children: [
          //     {
          ...
          //       path: paths.dashboard.storeInventory.expiryDateTracking,
          //       icon: ICONS.calendar,
          //     },
          //     {
          //       title: 'Move History',
          //       path: paths.dashboard.storeInventory.moveHistory,
          //       icon: ICONS.shift,
          //     },
          //     {
          //       title: 'Lot Traceability',
          //       path: paths.dashboard.storeInventory.lotTraceability,
          //       icon: ICONS.analytics,
          //     },
          //     {
          //       title: 'Product Recalls',
          //       path: paths.dashboard.storeInventory.productRecalls,
          //       icon: ICONS.notifications,
          //     },
          //   ],
          // },
          {
            ...
            children: [
              ...
              // {
              //   title: 'Quality Teams',
              //   path: paths.dashboard.storeInventory.qualityTeams,
              //   icon: ICONS.beneficiaries,
              // },
              // {
              //   title: 'QC Templates',
              //   path: paths.dashboard.storeInventory.qcTemplates,
              //   icon: ICONS.documents,
              // },
            ],
          },
          ...
          //   path: paths.dashboard.storeInventory.inventoryValuation,
          //   icon: ICONS.accounting,
          //   children: [
          //     {
          ...
          //     {
          //       title: 'Landed Costs',
          //       path: paths.dashboard.storeInventory.landedCosts,
          //       icon: ICONS.payment,
          //     },
          //     {
          //       title: 'Valuation Methods',
          //       path: paths.dashboard.storeInventory.valuationMethods,
          //       icon: ICONS.settings,
          //     },
          //     {
          //       title: 'Valuation Layers',
          //       path: paths.dashboard.storeInventory.stockValuationLayers,
          //       icon: ICONS.analytics,
          //     },
          //   ],
          // },
          {
            ...
            children: [
              ...
              //   path: paths.dashboard.storeInventory.mobileWarehouse,
              //   icon: ICONS.external,
              // },
            ],
          },
          // {
          //   title: 'Reports & Analytics',
          //   path: paths.dashboard.storeInventory.stock_reports,
          //   icon: ICONS.reports,
          //   children: [
          //     {
          //       title: 'Inventory Log',
          ...
          //       path: paths.dashboard.storeInventory.forecastedStock,
          //       icon: ICONS.analytics,
          //     },
          //     {
          //       title: 'Stock Aging Report',
          //       path: paths.dashboard.storeInventory.stockAgingReport,
          //       icon: ICONS.calendar,
          //     },
          //     {
          //       title: 'ABC Analysis',
          //       path: paths.dashboard.storeInventory.abcAnalysis,
          //       icon: ICONS.analytics,
          //     },
          //     {
          //       title: 'Consumption Report',
          //       path: paths.dashboard.storeInventory.consumptionReport,
          //       icon: ICONS.reports,
          //     },
          //     {
          //       title: 'Wastage Report',
          //       path: paths.dashboard.storeInventory.wastageReport,
          //       icon: ICONS.reports,
          //     },
          //     {
          //       title: 'Turnover Analysis',
          //       path: paths.dashboard.storeInventory.turnoverAnalysis,
          //       icon: ICONS.analytics,
          //     },
          //     {
          //       title: 'Landed Cost Report',
          //       path: paths.dashboard.storeInventory.landedCostReport,
          //       icon: ICONS.accounting,
          //     },
          //   ],
          // },
          ...
          //   path: paths.dashboard.storeInventory.donorFundedInventory,
          //   icon: ICONS.projects,
          //   children: [
          //     {
          //       title: 'Donor-Funded Inventory',
          //       path: paths.dashboard.storeInventory.donorFundedInventory,
          //       icon: ICONS.projects,
          //     },
          //     {
          //       title: 'Field Distribution',
          //       path: paths.dashboard.storeInventory.fieldDistribution,
          //       icon: ICONS.delivery,
          //     },
          //     {
          //       title: 'Humanitarian Kitting',
          //       path: paths.dashboard.storeInventory.humanitarianKitting,
          //       icon: ICONS.requisition,
          //     },
          //     {
          //       title: 'Emergency Reserves',
          //       path: paths.dashboard.storeInventory.emergencyReserves,
          //       icon: ICONS.notifications,
          //     },
          //     {
          //       title: 'Pipeline Tracking',
          //       path: paths.dashboard.storeInventory.pipelineTracking,
          //       icon: ICONS.shift,
          //     },
          //     {
          //       title: 'Commodity Tracking',
          //       path: paths.dashboard.storeInventory.commodityTracking,
          //       icon: ICONS.inventory,
          //     },
          //     {
          //       title: 'Waybill Management',
          //       path: paths.dashboard.storeInventory.waybillManagement,
          //       icon: ICONS.documents,
          //     },
          //     {
          //       title: 'Disposal Management',
          //       path: paths.dashboard.storeInventory.disposalManagement,
          //       icon: ICONS.menuItem,
          //     },
          //     {
          //       title: 'Loss & Damage Claims',
          //       path: paths.dashboard.storeInventory.lossDamageClaims,
          //       icon: ICONS.reports,
          //     },
          //     {
          //       title: 'Beneficiary Distribution',
          //       path: paths.dashboard.storeInventory.beneficiaryDistribution,
          //       icon: ICONS.beneficiaries,
          //     },
          //     {
          //       title: 'Field Warehouse',
          //       path: paths.dashboard.storeInventory.fieldWarehouse,
          //       icon: ICONS.department,
          //     },
          //     {
          //       title: 'Customs & Import',
          //       path: paths.dashboard.storeInventory.customsImportTracking,
          //       icon: ICONS.external,
          //     },
          //     {
          //       title: 'Vehicle Dispatch',
          //       path: paths.dashboard.storeInventory.vehicleDispatch,
          //       icon: ICONS.delivery,
          //     },
          //   ],
          // },
          // {
          //   title: 'Approvals',
          //   path: paths.dashboard.storeInventory.approvals,
          //   icon: ICONS.approval,
          // },
          {
            title: 'Settings',
            ...
            children: [
              ...
              {
                title: 'Approval Matrix',
                path: paths.dashboard.storeInventory.inventoryApprovalMatrix,
                icon: ICONS.approval,
              },
              {
                title: 'Approval Workflow',
              ...
              //   path: paths.dashboard.storeInventory.shippingMethods,
              //   icon: ICONS.delivery,
              // },
              // {
              //   title: 'Package Types',
              //   path: paths.dashboard.storeInventory.packageTypes,
              //   icon: ICONS.categories,
              // },
              // {
              //   title: 'Inventory Settings',
              //   path: paths.dashboard.storeInventory.inventorySettings,
              //   icon: ICONS.settings,
              // },
            ],
          },
  ...
  }, [hasPermission, user?.role, canShowWebLogin]);
