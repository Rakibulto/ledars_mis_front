...
import { useDeferredRevenueApi } from './use-deferred-revenue-api';
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      >
        <Stack spacing={0.5}>
          ...
          <Typography variant="body2" color="text.secondary">
            Revenue recognition workspace for subscriptions, grants, and service contracts.
          </Typography>
        </Stack>
      ...
      <Alert severity="info" sx={{ mb: 3, borderRadius: 2 }}>
        <AlertTitle>Revenue recognition control active</AlertTitle>
        Deferred revenue schedules track unearned income with period-based recognition schedules.
      </Alert>
        ...
        <CardContent>
          <Stack direction={{ xs: 'column', md: 'row' }} spacing={2}>
            <TextField
              fullWidth
              size="small"
              placeholder="Search reference, description, or contract dates"
              value={search}
      ...
      <Grid container spacing={3}>
        <Grid size={{ xs: 12 }}>
          {/* Recognition Queue commented out */}
          {/* <Card sx={{ mb: 3, borderRadius: 3 }}>
            <CardContent>
                      ...
                      <TableCell align="right">
                        <Stack direction="row" justifyContent="flex-end" spacing={1}>
                          ...
                          <Button
                            ...
                            href={paths.dashboard.accountingFinance.transactions.deferredRevenueDetail(
                              record.id
                            )}
                          >
                            View
                    ...
                    <TableRow>
                      <TableCell colSpan={9}>
                        <Box sx={{ py: 6, textAlign: 'center' }}>
                          <Typography variant="body2" color="text.secondary">
                            No deferred revenue schedules match the current filters.
                          </Typography>
                        </Box>
                      </TableCell>
                    </TableRow>
      ...
      <Dialog open={createOpen} onClose={() => setCreateOpen(false)} maxWidth="sm" fullWidth>
        ...
        <DialogContent>
          <Stack spacing={2} sx={{ mt: 1 }}>
            <Alert severity="info">
              Create a draft recognition schedule for grants, retainers, or prepaid service
              contracts.
            </Alert>
            <TextField
              fullWidth
