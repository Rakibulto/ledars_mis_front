...
export function printReceivablesPack(config) {
  printTransactionPack(normalizeConfig(config));
}

export function exportReceivablesCsv(fileName, config) {
  exportCsvFile(fileName, buildTransactionCsvRows(normalizeConfig(config)));
}

export function exportReceivablesExcel(fileName, config) {
  exportExcelWorkbook(fileName, buildTransactionWorkbookData(normalizeConfig(config)));
}

export function exportReceivablesJson(fileName, config) {
