...
export function ConsumableStockDetail() {
  const id = 'INV-AAB-2026-0045'; // mock id
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Card className="border-l-4 border-l-green-500">
              <CardBody>
                ...
                <p className="text-xl font-bold text-green-500">{item.currentStock}</p>
            ...
            <Card>
              <CardBody>
                ...
                <p className="text-xl font-bold text-foreground">{item.minStock}</p>
                <p className="text-xs text-muted-foreground mt-1">units</p>
              </CardBody>
            </Card>
            <Card>
              <CardBody>
                ...
                <p className="text-xl font-bold text-warning">{item.reorderPoint}</p>
                <p className="text-xs text-muted-foreground mt-1">units</p>
              </CardBody>
            </Card>
            <Card>
              <CardBody>
                ...
                <p className="text-xl font-bold text-foreground">{item.maxStock}</p>
                <p className="text-xs text-muted-foreground mt-1">units</p>
              </CardBody>
            </Card>
          </div>
                ...
                {item.recentTransactions.map((txn, index) => (
                  ...
                  >
                    <div className="flex items-center gap-3 flex-1">
                      <div
                        className={`w-8 h-8 shrink-0 rounded-lg flex items-center justify-center ${txn.type === 'Stock In' ? 'bg-success/10' : txn.type === 'Transfer' ? 'bg-primary/10' : 'bg-warning/10'}`}
                      >
                        {txn.type === 'Stock In' ? (
            ...
            <CardBody>
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xl font-bold text-warning">{item.monthlyUsage.issued}</p>
                  <p className="text-xs text-muted-foreground mt-1">units</p>
                </div>
                <div>
                  <p className="text-xs text-muted-foreground mb-1">Received</p>
                  <p className="text-xl font-bold text-success">{item.monthlyUsage.received}</p>
                  <p className="text-xs text-muted-foreground mt-1">units</p>
                </div>
